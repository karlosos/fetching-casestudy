...
export const deleteElementBrowserMockHandler = rest.delete(createApiUrl(DELETE_ELEMENT_URL), async (req, res, ctx) => {
...
export const deleteElementResponseHandler = rest.delete(createApiUrl(DELETE_ELEMENT_URL), async (req, res, ctx) => {
  return res(ctx.status(204));
});
